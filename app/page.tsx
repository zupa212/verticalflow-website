...
export default function HomePage() {
  ...
  return (
    <div className="bg-black text-white min-h-screen">
      ...
      {/* Development Section */}
      <section id="development" className="relative py-32 lg:py-40 bg-black overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
          ...
          >
            <h2 className="text-4xl lg:text-6xl font-black leading-tight mb-6 text-white">
              Check Our Dev Work
            </h2>
            <p className="text-lg lg:text-xl text-white/80 max-w-2xl mx-auto mb-12 leading-relaxed">
              Modern digital experiences built with cutting-edge technology
            </p>
            <Link href="/projects">
              <Button className="bg-white text-black hover:bg-white/90 rounded-full px-8 py-6 text-lg font-bold tracking-wide transition-all duration-300 hover:scale-105 shadow-[0_0_30px_rgba(255,255,255,0.3)]">
